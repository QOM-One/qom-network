...
const (
	// AttoQom defines the default coin denomination used in Evmos in:
	//
...
func NewEvmosCoin(amount sdkmath.Int) sdk.Coin {
	return sdk.NewCoin(AttoQom, amount)
}
...
func NewEvmosDecCoin(amount sdkmath.Int) sdk.DecCoin {
	return sdk.NewDecCoin(AttoQom, amount)
}
...
func NewEvmosCoinInt64(amount int64) sdk.Coin {
	return sdk.NewInt64Coin(AttoQom, amount)
}
