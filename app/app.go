...
import (
	...
	_ "github.com/QOM-One/QomApp/v7/client/docs/statik"

	"github.com/QOM-One/QomApp/v7/app/ante"
	"github.com/QOM-One/QomApp/v7/x/epochs"
	epochskeeper "github.com/QOM-One/QomApp/v7/x/epochs/keeper"
	epochstypes "github.com/QOM-One/QomApp/v7/x/epochs/types"
	"github.com/QOM-One/QomApp/v7/x/erc20"
	erc20client "github.com/QOM-One/QomApp/v7/x/erc20/client"
	erc20keeper "github.com/QOM-One/QomApp/v7/x/erc20/keeper"
	erc20types "github.com/QOM-One/QomApp/v7/x/erc20/types"

	"github.com/QOM-One/QomApp/v7/x/inflation"
	inflationkeeper "github.com/QOM-One/QomApp/v7/x/inflation/keeper"
	inflationtypes "github.com/QOM-One/QomApp/v7/x/inflation/types"
	"github.com/QOM-One/QomApp/v7/x/onboarding"
	onboardingkeeper "github.com/QOM-One/QomApp/v7/x/onboarding/keeper"
	onboardingtypes "github.com/QOM-One/QomApp/v7/x/onboarding/types"

	//govshuttle imports
	"github.com/QOM-One/QomApp/v7/x/govshuttle"
	govshuttleclient "github.com/QOM-One/QomApp/v7/x/govshuttle/client"
	govshuttlekeeper "github.com/QOM-One/QomApp/v7/x/govshuttle/keeper"
	govshuttletypes "github.com/QOM-One/QomApp/v7/x/govshuttle/types"

	"github.com/QOM-One/QomApp/v7/x/csr"
	csrkeeper "github.com/QOM-One/QomApp/v7/x/csr/keeper"
	csrtypes "github.com/QOM-One/QomApp/v7/x/csr/types"

	"github.com/QOM-One/QomApp/v7/x/coinswap"
	coinswapkeeper "github.com/QOM-One/QomApp/v7/x/coinswap/keeper"
	coinswaptypes "github.com/QOM-One/QomApp/v7/x/coinswap/types"

	v2 "github.com/QOM-One/QomApp/v7/app/upgrades/v2"
	v3 "github.com/QOM-One/QomApp/v7/app/upgrades/v3"
	v4 "github.com/QOM-One/QomApp/v7/app/upgrades/v4"
	v5 "github.com/QOM-One/QomApp/v7/app/upgrades/v5"
	v6 "github.com/QOM-One/QomApp/v7/app/upgrades/v6"
	v7 "github.com/QOM-One/QomApp/v7/app/upgrades/v7"
)
...
func init() {
	...
	// manually update the power reduction by replacing micro (u) -> atto (a) Qom
...
func (app *Qom) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Qom) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *Qom) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
func (app *Qom) SimulationManager() *module.SimulationManager {
	return app.sm
}
...
func (app *Qom) GetStakingKeeper() stakingkeeper.Keeper {
...
func (app *Qom) GetErc20Keeper() erc20keeper.Keeper {
	return app.Erc20Keeper
}

func (app *Qom) GetCoinswapKeeper() coinswapkeeper.Keeper {
	return app.CoinswapKeeper
}

func (app *Qom) GetOnboardingKeeper() *onboardingkeeper.Keeper {
