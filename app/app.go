...
import (
	...
	ethante "github.com/qom-one/qomapp/v1/app/ante/evm"
	"github.com/qom-one/qomapp/v1/encoding"
	"github.com/qom-one/qomapp/v1/ethereum/eip712"
	srvflags "github.com/qom-one/qomapp/v1/server/flags"
	qomtypes "github.com/qom-one/qomapp/v1/types"
	"github.com/qom-one/qomapp/v1/x/evm"
	evmkeeper "github.com/qom-one/qomapp/v1/x/evm/keeper"
	evmtypes "github.com/qom-one/qomapp/v1/x/evm/types"
	"github.com/qom-one/qomapp/v1/x/feemarket"
	feemarketkeeper "github.com/qom-one/qomapp/v1/x/feemarket/keeper"
	feemarkettypes "github.com/qom-one/qomapp/v1/x/feemarket/types"

	// unnamed import of statik for swagger UI support
	_ "github.com/qom-one/qomapp/v1/client/docs/statik"

	"github.com/qom-one/qomapp/v1/app/ante"
	"github.com/qom-one/qomapp/v1/x/claims"
	claimskeeper "github.com/qom-one/qomapp/v1/x/claims/keeper"
	claimstypes "github.com/qom-one/qomapp/v1/x/claims/types"
	"github.com/qom-one/qomapp/v1/x/epochs"
	epochskeeper "github.com/qom-one/qomapp/v1/x/epochs/keeper"
	epochstypes "github.com/qom-one/qomapp/v1/x/epochs/types"
	"github.com/qom-one/qomapp/v1/x/erc20"
	erc20client "github.com/qom-one/qomapp/v1/x/erc20/client"
	erc20keeper "github.com/qom-one/qomapp/v1/x/erc20/keeper"
	erc20types "github.com/qom-one/qomapp/v1/x/erc20/types"
	"github.com/qom-one/qomapp/v1/x/incentives"
	incentivesclient "github.com/qom-one/qomapp/v1/x/incentives/client"
	incentiveskeeper "github.com/qom-one/qomapp/v1/x/incentives/keeper"
	incentivestypes "github.com/qom-one/qomapp/v1/x/incentives/types"
	"github.com/qom-one/qomapp/v1/x/inflation"
	inflationkeeper "github.com/qom-one/qomapp/v1/x/inflation/keeper"
	inflationtypes "github.com/qom-one/qomapp/v1/x/inflation/types"
	"github.com/qom-one/qomapp/v1/x/recovery"
	recoverykeeper "github.com/qom-one/qomapp/v1/x/recovery/keeper"
	recoverytypes "github.com/qom-one/qomapp/v1/x/recovery/types"
	revenue "github.com/qom-one/qomapp/v1/x/revenue/v1"
	revenuekeeper "github.com/qom-one/qomapp/v1/x/revenue/v1/keeper"
	revenuetypes "github.com/qom-one/qomapp/v1/x/revenue/v1/types"
	"github.com/qom-one/qomapp/v1/x/vesting"
	vestingkeeper "github.com/qom-one/qomapp/v1/x/vesting/keeper"
	vestingtypes "github.com/qom-one/qomapp/v1/x/vesting/types"

	// NOTE: override ICS20 keeper to support IBC transfers of ERC20 tokens
	"github.com/qom-one/qomapp/v1/x/ibc/transfer"
	transferkeeper "github.com/qom-one/qomapp/v1/x/ibc/transfer/keeper"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".qomd")

	// manually update the power reduction by replacing micro (u) -> atto (a) evmos
	sdk.DefaultPowerReduction = qomtypes.PowerReduction
...
var (
	_ servertypes.Application = (*Qom)(nil)
	_ ibctesting.TestingApp   = (*Qom)(nil)
)

// Qom implements an extended ABCI application. It is an application
...
// NewQom returns a reference to a new initialized Ethermint application.
func NewQom(
	logger log.Logger,
	db dbm.DB,
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		appCodec, keys[authtypes.StoreKey], app.GetSubspace(authtypes.ModuleName), qomtypes.ProtoAccount, maccPerms, sdk.GetConfig().GetBech32AccountAddrPrefix(),
	)
...
func (app *Qom) Name() string { return app.BaseApp.Name() }

func (app *Qom) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := ante.HandlerOptions{
		Cdc:                    app.appCodec,
		AccountKeeper:          app.AccountKeeper,
		BankKeeper:             app.BankKeeper,
		ExtensionOptionChecker: qomtypes.HasDynamicFeeExtensionOption,
...
func (app *Qom) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
...
func (app *Qom) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// The DeliverTx method is intentionally decomposed to calculate the transactions per second.
func (app *Qom) DeliverTx(req abci.RequestDeliverTx) (res abci.ResponseDeliverTx) {
	defer func() {
...
func (app *Qom) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *Qom) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Qom) ModuleAccountAddrs() map[string]bool {
...
func (app *Qom) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Qom's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Qom) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Qom's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Qom) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Qom's InterfaceRegistry
func (app *Qom) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Qom) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Qom) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Qom) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Qom) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *Qom) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Qom) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *Qom) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Qom) RegisterNodeService(clientCtx client.Context) {
...
func (app *Qom) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Qom) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *Qom) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Qom) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Qom) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Qom) GetTxConfig() client.TxConfig {
