...
import (
	...
	"github.com/QOM-One/QomApp/cmd/config"
...
// Setup initializes a new Qom. A Nop logger is set in Qom.
func Setup(
	isCheckTx bool,
	...
	db := dbm.NewMemDB()
	app := NewQom(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, 5, encoding.MakeConfig(ModuleBasics), simapp.EmptyAppOptions{})
	if !isCheckTx {
...
func GenesisStateWithValSet(app *Qom, genesisState simapp.GenesisState,
...
func SetupTestingApp() (ibctesting.TestingApp, map[string]json.RawMessage) {
	...
	app := NewQom(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, 5, cfg, simapp.EmptyAppOptions{})
