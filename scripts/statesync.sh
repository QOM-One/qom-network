...
# Initialize chain.
qomd init test --chain-id evmos_9000-2

# Get Genesis
wget https://archive.evmos.org/mainnet/genesis.json
mv genesis.json ~/.qomd/config/

wget -O ~/.qomd/config/adrbook.json https://snapshot.notional.ventures/evmos/addrbook.json
...
export QOMD_P2P_MAX_NUM_INBOUND_PEERS=200
