...
// source: qom/claims/v1/claims.proto
...
func (Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_6f38fc9f808d20b8, []int{0}
}
...
type Claim struct {
	// action enum
	Action Action `protobuf:"varint,1,opt,name=action,proto3,enum=qom.claims.v1.Action" json:"action,omitempty"`
...
func (*ClaimsRecordAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_6f38fc9f808d20b8, []int{1}
}
...
func (*ClaimsRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_6f38fc9f808d20b8, []int{2}
}
...
func init() {
	proto.RegisterEnum("qom.claims.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "qom.claims.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "qom.claims.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "qom.claims.v1.ClaimsRecord")
}

func init() { proto.RegisterFile("qom/claims/v1/claims.proto", fileDescriptor_6f38fc9f808d20b8) }

var fileDescriptor_6f38fc9f808d20b8 = []byte{
	// 511 bytes of a gzipped FileDescriptorProto
	,
}
