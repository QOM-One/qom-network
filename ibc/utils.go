...
import (
	...
	qom "github.com/QOM-One/QomApp/types"
)
...
func GetTransferSenderRecipient(packet channeltypes.Packet) (
	...
	// and change the bech32 human readable prefix (HRP) of the sender to `qom`
	...
	// and change the bech32 human readable prefix (HRP) of the recipient to `qom`
